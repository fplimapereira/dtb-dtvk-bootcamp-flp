...
dbutils.fs.mount(
    source = "wasbs://sandbox@dlsdtvkbootcampprdflp.blob.core.windows.net"
    ,mount_point = "/mnt/sandbox/"
    ,extra_configs = {"fs.azure.account.key.dlsdtvkbootcampprdflp.blob.core.windows.net" :dbutils.secrets.get(scope = "scopo-kv-dtvk-botcamp-prd-flp", key = "secret-dlsdtvkbootcampprdflp")}
)
...
config =  {"fs.azure.account.key.dlsdtvkbootcampprdflp.blob.core.windows.net" :dbutils.secrets.get(scope = "scopo-kv-dtvk-botcamp-prd-flp", key = "secret-dlsdtvkbootcampprdflp")}
...
def mount_diretorio_lake(lst_diretorios):
    try:        
        for diretorio in lst_diretorios:
            dbutils.fs.mount(
                source = f"wasbs://{diretorio}@dlsdtvkbootcampprdflp.blob.core.windows.net"
